 ...
 */
class CloseWithoutInteraction extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
    ...
    {
        return $this->_popupHelper->getPopupImpressions($row, 'close_without_interaction');
    }
}
